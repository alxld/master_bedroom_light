...
light_entity = "light.master_bedroom_group"
# harmony_entity = "remote.theater_harmony_hub"
switch_action = "zigbee2mqtt/Master Bedroom Switch/action"
motion_sensor_action = "zigbee2mqtt/Master Bedroom Motion Sensor"
brightness_step = 43
...
class MasterBedroomLight(LightEntity):
    """Master Bedroom Light."""

    def __init__(self) -> None:
        """Initialize Master Bedroom Light."""
        self._light = light_entity
        self._name = "Master Bedroom"
        # self._state = 'off'
        self._brightness = 0
    ...
    def should_poll(self):
        """Allows for color changes to be polled"""
        return True
